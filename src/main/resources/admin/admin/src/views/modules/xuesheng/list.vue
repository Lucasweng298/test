        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="身份证">
		     <template slot-scope="scope">
                ...
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="chushengnianyue"
                    header-align="center"
		    label="出生年月">
		     <template slot-scope="scope">
                       {{scope.row.chushengnianyue}}
                     </template>
                </el-table-column>
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
		    ...
		    label="辅导员姓名">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="gerenjineng"
                    header-align="center"
                    label="个人技能">
                    <template slot-scope="scope">
                      <el-button type="text" size="small" @click="download(scope.row.gerenjineng)">下载</el-button>
                    </template>
                  </el-table-column>
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="jiangxiangzhengshu"
                    header-align="center"
                    label="奖项证书">
                    <template slot-scope="scope">
                      <el-button type="text" size="small" @click="download(scope.row.jiangxiangzhengshu)">下载</el-button>
                    </template>
                  </el-table-column>
              <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                  prop="shhf"
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          chushengnianyue: row.chushengnianyue,
          fudaoyuangonghao: row.fudaoyuangonghao,
          fudaoyuanxingming: row.fudaoyuanxingming,
          gerenjineng: row.gerenjineng,
          jiangxiangzhengshu: row.jiangxiangzhengshu,
          sfsh: row.sfsh,
          shhf: row.shhf,
          id: row.id
        }
