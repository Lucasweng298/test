...
public class XueshengController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengEntity xuesheng,
		...
		if(tableName.equals("xuesheng")) {
			xuesheng.setXueshengzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("fudaoyuan")) {
			xuesheng.setFudaoyuangonghao((String)request.getSession().getAttribute("username"));
		}
