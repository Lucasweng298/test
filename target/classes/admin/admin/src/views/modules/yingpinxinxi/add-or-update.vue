<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="简历投递" prop="jianlitoudi">
          <file-upload
          tip="点击上传简历投递"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jianlitoudi" label="简历投递" prop="jianlitoudi">
            <el-button type="text" size="small" @click="download(ruleForm.jianlitoudi)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="应聘日期" prop="yingpinriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yingpinriqi" label="应聘日期" prop="yingpinriqi">
              <el-input v-model="ruleForm.yingpinriqi" 
                placeholder="应聘日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.yingpinriqi = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jianlitoudi = true;
            continue;
          }
          if(o=='yingpinriqi'){
            this.ruleForm.yingpinriqi = obj[o];
	    this.ro.yingpinriqi = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.jianlitoudi = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
