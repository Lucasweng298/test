<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="企业资质" prop="qiyezizhi">
          <file-upload
          tip="点击上传企业资质"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.qiyezizhi" label="企业资质" prop="qiyezizhi">
            <el-button type="text" size="small" @click="download(ruleForm.qiyezizhi)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.yingyexukezheng" label="营业许可证" prop="yingyexukezheng">
          <file-upload
          tip="点击上传营业许可证"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.yingyexukezheng?ruleForm.yingyexukezheng:''"
          @change="yingyexukezhengUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.yingyexukezheng" label="营业许可证" prop="yingyexukezheng">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yingyexukezheng.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiyezizhi = true;
          ...
          if(o=='yingyexukezheng'){
            this.ruleForm.yingyexukezheng = obj[o];
	    this.ro.yingyexukezheng = true;
            continue;
          }
        }
      }
    ...
    yingyexukezhengUploadChange(fileUrls) {
	this.ruleForm.yingyexukezheng = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
