<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作城市" prop="gongzuochengshi">
          <el-input v-model="ruleForm.gongzuochengshi" 
              placeholder="工作城市" clearable  :readonly="ro.gongzuochengshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作城市" prop="gongzuochengshi">
              <el-input v-model="ruleForm.gongzuochengshi" 
                placeholder="工作城市" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.leixing = true;
          ...
          if(o=='gongzuochengshi'){
            this.ruleForm.gongzuochengshi = obj[o];
	    this.ro.gongzuochengshi = true;
            continue;
          }
          if(o=='gongzuodanwei'){
      ...
      this.$http({
		...
		if(json.fudaoyuangonghao!=''&&json.fudaoyuangonghao){
              		this.ruleForm.fudaoyuangonghao = json.fudaoyuangonghao
		}
		if(json.fudaoyuanxingming!=''&&json.fudaoyuanxingming){
              		this.ruleForm.fudaoyuanxingming = json.fudaoyuanxingming
		}
        } else {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `biyequxiang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.biyequxiangCrossAddOrUpdateFlag = false;
                  this.parent.search();
