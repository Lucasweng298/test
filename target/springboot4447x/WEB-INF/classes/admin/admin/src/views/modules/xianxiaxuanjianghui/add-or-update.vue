<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宣讲主题" prop="xuanjiangzhuti">
          <el-input v-model="ruleForm.xuanjiangzhuti" 
              placeholder="宣讲主题" clearable  :readonly="ro.xuanjiangzhuti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宣讲主题" prop="xuanjiangzhuti">
              <el-input v-model="ruleForm.xuanjiangzhuti" 
                placeholder="宣讲主题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学楼" prop="jiaoxuelou">
          <el-input v-model="ruleForm.jiaoxuelou" 
              placeholder="教学楼" clearable  :readonly="ro.jiaoxuelou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学楼" prop="jiaoxuelou">
              <el-input v-model="ruleForm.jiaoxuelou" 
                placeholder="教学楼" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="空闲教室" prop="kongxianjiaoshi">
          <el-input v-model="ruleForm.kongxianjiaoshi" 
              placeholder="空闲教室" clearable  :readonly="ro.kongxianjiaoshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="空闲教室" prop="kongxianjiaoshi">
              <el-input v-model="ruleForm.kongxianjiaoshi" 
                placeholder="空闲教室" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教室容量" prop="jiaoshirongliang">
          <el-input v-model="ruleForm.jiaoshirongliang" 
              placeholder="教室容量" clearable  :readonly="ro.jiaoshirongliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教室容量" prop="jiaoshirongliang">
              <el-input v-model="ruleForm.jiaoshirongliang" 
                placeholder="教室容量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	xuanjiangzhuti : false,
	jiaoxuelou : false,
	kongxianjiaoshi : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='xuanjiangzhuti'){
            this.ruleForm.xuanjiangzhuti = obj[o];
	    this.ro.xuanjiangzhuti = true;
            continue;
          }
          if(o=='jiaoxuelou'){
            this.ruleForm.jiaoxuelou = obj[o];
	    this.ro.jiaoxuelou = true;
            continue;
          }
          if(o=='kongxianjiaoshi'){
            this.ruleForm.kongxianjiaoshi = obj[o];
	    this.ro.kongxianjiaoshi = true;
            continue;
          }
    ...
    info(id) {
      this.$http({
        url: `xianxiaxuanjianghui/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../springboot4447x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xianxiaxuanjianghui/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xianxiaxuanjianghuiCrossAddOrUpdateFlag = false;
                  this.parent.search();
